...
#
cd $PBS_O_WORKDIR
cd $HOME/mikkel/performanceTests/16thread/OnlineClustering/
./OnlineClustering 7 10 1.6 1 1
./OnlineClustering 7 10 1.6 10 10
./OnlineClustering 7 10 1.6 100 100
./OnlineClustering 7 10 1.6 1000 1000
./OnlineClustering 7 10 1.6 10000 10000
#
