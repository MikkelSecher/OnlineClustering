...
#
cd $PBS_O_WORKDIR
cd $HOME/mikkel/mpitests/threads2/OnlineClustering/
mpirun -np 2 ./OnlineClustering 6 8 1.60 11 1
mpirun -np 2 ./OnlineClustering 6 8 1.60 11 2
mpirun -np 2 ./OnlineClustering 6 8 1.60 11 4
